...
namespace DevelopersHub.Migrations
{
    ...
    [Migration("20260812041031_AñadirColumnaColorHexa")]
    partial class AñadirColumnaColorHexa
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DevelopersHub.Models.Categoria", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DevelopersHub.Models.Publicacion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DevelopersHub.Models.Usuario", b =>
                {
            ...
            modelBuilder.Entity("DevelopersHub.Models.Publicacion", b =>
                {
                    b.HasOne("DevelopersHub.Models.Categoria", "Categoria")
                        .WithMany("Publicaciones")
                        .HasForeignKey("CategoriaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DevelopersHub.Models.Usuario", "Usuario")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DevelopersHub.Models.Usuario", null)
                        .WithMany()
